...
func (in *StatefulEntity) DeepCopyInto(out *StatefulEntity) {
	*out = *in
	...
	if in.InputSidecar != nil {
		in, out := &in.InputSidecar, &out.InputSidecar
		*out = new(string)
		**out = **in
	}
	...
	if in.StateSidecar != nil {
		in, out := &in.StateSidecar, &out.StateSidecar
		*out = new(string)
		**out = **in
	}
	if in.OutputSidecar != nil {
		in, out := &in.OutputSidecar, &out.OutputSidecar
		*out = new(string)
		**out = **in
	}
